            ...
            <div className="md:w-2/3 w-full px-4 text-white flex flex-col">
                ...
                <div className="flex mt-8 flex-col md:flex-row md:justify-between">
                    <p className="w-full md:w-2/3 text-gray-400">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi blandit magna sit amet convallis auctor. Etiam facilisis interdum finibus.
                        Aenean id ante in nulla dignissim maximus. Interdum et malesuada fames ac ante ipsum primis in faucibus.</p>
                ...
                <div className="flex flex-col">
                    <div className="flex mt-24 mb-12 flex-row justify-between">
                        <div className="">
                            <img id="logo-footer" src="assets/llaw-logo.jpg" />
                        </div>
                    ...
                    <p className="w-full text-center my-12 text-gray-600">Copyright © 2025 Loophole</p>
                </div>
            </div>
        </div>
    );
